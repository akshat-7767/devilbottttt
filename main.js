...
//| Creator : FebzDev (Penata Ulang)
//| Developer : Fadhil Graphy
//| Devoloper : FebzGanz
//| Recode From : Zobin33 & MhankBarBar
//|━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
//| Recode? Somry TyDak Semudah Itu Pedo
//| Tamatin One Piece Dlu:v (ENC NO RECODE)
//|━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
//| Punten stah, kang recode izin lewat
//| TQTO in the below section
//|━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━|
const {
    WAConnection,
    MessageType,
...
/*prefix = `#`*/
botname = 'FEBZABOTZ' //GANTI JADI NAMA BOT LU
blocked = []
fakereply = '© Created By FebGanz' //OY PEDO!JANDIUBAH ERROR
fake = 'FEBZABOTZ' //ASLI KLO ERROR SALAH ELU BODO
...
async function starts() {
    ...
    /*lolcatjs.fromString('[DEV] FADHIL GRAPHY')
...
client.on('group-participants-update', async (anu) => {
	...
	teks = `Sayonara Pedo @${num.split('@')[0]}👋`
	let buff = await getBuffer(ppimg)
	client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
	}
	} catch (e) {
		...
		try{
			...
			switch(_client.action){
				...
				case 'remove':
					...
					teks = `*𝚑𝚊𝚕𝚘 @${num.split("@")[0]} 👋 𝚜𝚎𝚕𝚊𝚖𝚊𝚝 𝚍𝚊𝚝𝚊𝚗𝚐 𝚍𝚒 𝚐𝚛𝚘𝚞𝚙 ${mdata.subject}}*`;
...
//dah la malrs
  ...
  msg = JSON.parse(JSON.stringify(msg)).messages[0]
   ...
   const ownerNumber = ["6288221608614@s.whatsapp.net","6283102650464@s.whatsapp.net"]
...
//=========FAKE TROLI=============
     ...
     /*      const ftroli = {
                    ...
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: 'Fadhil Graphy', //Kasih namalu
                            orderTitle: 'Bang',
            ...
            case 'developer':
                 ...
                 /*client.sendMessage(from, {displayname: "Jeff", vcard1: vcard}, MessageType.contact, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: {"contactMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "title": fakereply, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./blank.png')}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})*/
                  client.sendMessage(from, 'Tinggalkan Pesan Kepada Owner Kami!', text, { quoted: msg, contextInfo: { forwardingScore: 508, isForwarded: true}} )
					break
            case 'tes':
                   client.sendMessage(from, `${lang == 'id' ? `Halo kak👋, berikut perintah anonymous chat bot` : `Hi kak👋, following the anonymous chat bot command`}
                    `)
                   break
...
client.sendMessage('6283102650464@s.whatsapp.net',`*INFO DARI PENGGUNA*\n*Bug Report:* ${teks}`, text)
break
case 'request':
...
break
case 'groupbot':
const hal = "https://chat.whatsapp.com/BgLgs5l9QdRB1iMnMm5jN8"
client.sendMessage(from, hal, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": fake, "jpegThumbnail": fs.readFileSync(`./blank.png`)} }, contextInfo: {"forwardingScore": 999, "isForwarded": true} } })
break
case '>':
if (!isOwner) return
